...
use crate::{
    EciesAes128, R25519Point, X25519PublicKey, CURVE_25519_SECRET_LENGTH, R25519_SCALAR_LENGTH,
    X25519_PUBLIC_KEY_LENGTH,
};

#[cfg(all(feature = "aes", feature = "sha3",))]
pub type EciesR25519Aes128 = EciesAes128<R25519_SCALAR_LENGTH, R25519_SCALAR_LENGTH, R25519Point>;
#[cfg(all(feature = "aes", feature = "sha3",))]
