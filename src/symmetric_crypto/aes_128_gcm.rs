...
use aes_gcm::{
    ...
    AeadInPlace, Aes128Gcm as Aes128GcmLib, KeyInit,
};
...
pub fn encrypt_combined(
    ...
    Aes128GcmLib::new(GenericArray::from_slice(key))
    ...
    use crate::{
        ...
        symmetric_crypto::{
            aes_128_gcm::{
                ...
                encrypt_in_place_detached, Aes128Gcm, Nonce, KEY_LENGTH, MAC_LENGTH, NONCE_LENGTH,
            },
            key::SymmetricKey,
            nonce::NonceTrait,
            Dem,
